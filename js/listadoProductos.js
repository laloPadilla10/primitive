const arrayProductos = [
  {
    ...
    imagenes: ["https://i.ibb.co/MhnLRhm/spiderman-VSvenom.jpg"],
    description: "Funko Pop Comic Moment: Marvel.",
    price: "$1,800.00 MXN",
    categoria: "Figuras",
  },{
    name: "Cartera Mulan",
    imagenes: ["https://i.ibb.co/LQCxbrS/Cartera-Mulan.jpg"],
    description:
    ...
    imagenes: ["https://i.ibb.co/D5HqcR2/Figura-C3-PO.jpg"],
    description:
    ...
    name: "Wall-E y Eva",
    imagenes: ["https://i.ibb.co/wLGNhq1/Eva-Wall-e.jpg"],
    description:
  ...
  },
  {
    ...
    imagenes: ["https://i.ibb.co/f8SP3sJ/Auriculares-IRONMAN.jpg"],
    description:
  ...
  },
  {
    ...
    imagenes: ["https://i.ibb.co/v1QRGsp/Portalapices-Darth-Vader.jpg"],
    description:
  ...
  },
  {
    ...
    imagenes: ["https://i.ibb.co/T4jZ0yz/Waflera-Star-Wars.jpg"],
    description:
  ...
  },
  {
    ...
    imagenes: ["https://i.ibb.co/KG1CN1T/Mario-Amiibo.jpg"],
    ...
    imagenes: ["https://i.ibb.co/j4v7FXd/Cartera-Nintendo.jpg"],
    description: "Cartera para Hombre Edición Especial Super Nintendo.",
    price: "$270.00 MXN",
    categoria: "Accesorios"
  },{
    name: "Gorra Kirby",
    imagenes: ["https://i.ibb.co/zf4sYLX/kirby1.png"],
    description:
...
function cargarProductos(filtro) {
  ...
  for(let e of elementos){
    e.addEventListener("click", function (){
      verDetalle(arrayProductos.filter(a=> a.imagenes[0]===e.attributes["src"].value)[0])});
  }
}
    ...
    `<div class="col-md-4 col-sm-6 col-xs-12" id="card" style=" padding-bottom:20px;">
      <div class="card h-100">
        <div class="card-header">
            <img class="card-img imagenProducto" src="${item.imagenes[0]}" alt="${item.name}" style="height: 322px;">
        </div>
        <div class="card-body">
